...
.ledger-app{
  --bg:#f8fafc; --bg-deep:#1e293b; --bg-deep-2:#0f172a; --ink:#0f172a; --line:#e2e8f0;
  --income:#10b981; --income-soft:#ecfdf5; --expense:#ef4444; --expense-soft:#fef2f2;
  --gold:#f59e0b; --card:#ffffff; --muted:#64748b; --muted-2:#94a3b8; --radius:10px;
...
.ledger-app .brand-mark{width:30px; height:30px; border-radius:8px; background:rgba(245,158,11,0.18); border:1px solid rgba(245,158,11,0.4); display:flex; align-items:center; justify-content:center; font-family:'Fraunces',serif; font-size:15px; color:#f59e0b; flex-shrink:0;}
.ledger-app .brand-name{font-family:'Fraunces',serif; font-size:16px; color:#f8fafc; letter-spacing:-0.01em;}
...
.ledger-app .nav-link,.ledger-app .nav-group-toggle{display:flex; align-items:center; gap:10px; padding:9px 10px; border-radius:8px; font-size:13.5px; color:#94a3b8; text-decoration:none; cursor:pointer; border:none; background:transparent; width:100%; text-align:left; font-family:'Inter',sans-serif;}
.ledger-app .nav-link:hover,.ledger-app .nav-group-toggle:hover{background:rgba(255,255,255,0.06); color:#f8fafc;}
.ledger-app .nav-link.active{background:rgba(245,158,11,0.14); color:#f8fafc;}
...
.ledger-app .masthead h1{font-family:'Fraunces',serif; font-weight:500; font-size:32px; margin:0; letter-spacing:-0.01em;}
...
.ledger-app .figure dd{margin:0; font-family:'Fraunces',serif; font-size:34px; font-weight:500; letter-spacing:-0.01em;}
...
.ledger-app .card-head h2{font-family:'Fraunces',serif; font-weight:500; font-size:17.5px; margin:0;}
...
.ledger-app .stat-card .stat-amt{font-family:'Fraunces',serif; font-weight:500; font-size:24px; margin:0; letter-spacing:-0.01em;}
...
.ledger-app .search-row input{border:none; background:transparent; outline:none; font-family:'Inter',sans-serif; font-size:13.5px; color:var(--ink); width:100%;}
...
.ledger-app .section-title{font-family:'Fraunces',serif; font-weight:500; font-size:16px; margin:0 0 16px;}
...
.ledger-app .item-table td input,.ledger-app .item-table td select{font-family:'Inter',sans-serif; font-size:13px; border:1px solid var(--line); border-radius:7px; padding:8px 9px; width:100%; outline:none; background:#fff;}
...
.ledger-app .totals-row.grand span:first-child{font-family:'Fraunces',serif; font-size:15.5px; font-weight:500;}
...
.ledger-app .btn{font-family:'Inter',sans-serif; font-size:13.5px; font-weight:600; padding:11px 20px; border-radius:9px; cursor:pointer; border:1px solid transparent; transition:.15s ease;}
