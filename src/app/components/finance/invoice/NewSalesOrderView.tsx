...
export function NewSalesOrderView(props: {
  lines: LineItem[];
  ...
  const [orderDate, setOrderDate] = useState("2026-07-03");
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Sales Order ${saved.code ?? ""} saved successfully!`);
    } catch {
    ...
    <section className="view">
      <div className="masthead">
        <div>
          ...
          <p className="masthead-desc">Create a new customer sales order and manage billing status</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div className="form-grid">
            ...
            <Field label="Sales Order #">
              <input type="text" value="SLSODR/001" readOnly disabled style={{ background: "var(--bg)", cursor: "not-allowed", fontWeight: 600 }} />
            </Field>
            ...
            <Field label="PO Reference">
              <input type="text" value={poReference} onChange={(e) => setPoReference(e.target.value)} placeholder="Enter Reference Information" />
            </Field>
