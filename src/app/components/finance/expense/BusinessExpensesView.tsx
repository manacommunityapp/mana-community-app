              ...
              <tbody>
                {expenses.length === 0 ? (
                  <tr className="empty-table-row">
                    <td colSpan={8}>
                      <div className="glyph"><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M4 7h16M9 7V4h6v3m-8 0 1 13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1l1-13" stroke="#8b8fc8" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg></div>
                      No Expenses present.
                    </td>
                  </tr>
                ) : expenses.map((ex) => (
